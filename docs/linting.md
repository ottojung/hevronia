...
The custom plugin lives at `tools/eslint-plugin-hevronia/` and features:
...
2. **Edit the rule**: Modify `tools/eslint-plugin-hevronia/rules/my-rule-name.js`
...
- `tools/eslint-plugin-hevronia/rules/no-console-logs.js`
- `tools/eslint-plugin-hevronia/tests/no-console-logs.test.js`
