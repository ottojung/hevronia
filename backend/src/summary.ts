...
- what a character said, claimed, recalled, or asserted — write it as such ("user 42 said...", "user 42 claimed...") and never turn a claim into an established fact;
- what Хевронія herself said or did in the chat — write it as "you said..." / "you did...";
- display names and relationships, using stable spreadsheet labels when names collide;
...
- corrections a character made to earlier assumptions, attributed by spreadsheet label;
...
Use spreadsheet identity labels throughout: an individual is "user <id>" and a channel or chat sender is "channel <id>". These are stable labels for recurring dream characters. Never emit "telegram-user:" or "telegram-chat:" prefixes. Never merge two identities just because their display names match or because their statements conflict.
