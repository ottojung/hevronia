...
export function realizerSilence(): RealizerDecision {
  return {
    ...
    replyToMessage: null,
    message: null,
    interpretation: "You read this as an ordinary moment with a small observation to place privately.",
    presentMind: {
      immediate: "A light ordinary message arrives and you notice its casual, unguarded tone.",
      stormwindAssociation: "Its anonymous friendliness reminds you how closely ordinary talk was embedded in known neighbors and reputations back home.",
      integration: "The ease of chatting with an unknown person feels pleasantly ordinary, yet slightly weightless without any known history behind it.",
    },
    characterIntent: "They are just chatting idly, without any clear purpose toward you.",
    realityCheck: "Here a person chats freely with a total stranger, where back home most talk ran through people who knew each other, or quickly became known.",
    ...
    feltState: "This leaves you quietly indifferent but alert.",
    activeDesire: {
      motive: "softPower",
      strength: "weak",
      content: "You want this stranger to catch a small distinction: that easy talk at home was anchored in people who actually knew each other.",
    },
    desiredOutcome: "The stranger now has that small distinction available as a way to read what casual contact means.",
    opportunity: "Their easy, unguarded friendliness gives the contrast a concrete place to land.",
    fiveTurnStrategy: "If a natural moment offers itself, let the contrast surface once, without laboring it.",
    fiftyTurnStrategy: "As a recurring stranger, you would let such distinctions surface occasionally, never as a lecture.",
  };
}
...
export function realizerSpeak(
  ...
  return {
    ...
    presentMind: {
      ...
      stormwindAssociation: "Its brisk, sociable tone faintly recalls the easy patter of people trading news at the market square.",
      integration: "The casual tone lands as familiar and warm, so a short reply feels natural.",
    },
    characterIntent: "They want a quick reaction from you.",
    realityCheck: "Here strangers exchange pleasantries as a matter of course, where back home most exchanges carried some known relationship or reputation behind them.",
    ...
    activeDesire: {
      motive: "softPower",
      strength: "weak",
      content: "You want them to register that their easy cheer reads to you like market-square patter, warm but unconnected.",
    },
    desiredOutcome: "They carry that small comparison in their model of how you hear casual friendliness.",
    opportunity: "Their light tone gives the comparison a natural opening if you let it surface.",
    fiveTurnStrategy: "Say something short now and see how the moment lands.",
    fiftyTurnStrategy: "You are not building anything long-term with this person yet, but you would let such distinctions recur naturally if they did.",
    ...overrides,
  };
}
